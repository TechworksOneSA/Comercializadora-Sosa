...
<script>
    ...
    // Aunque vendedor no use modal de crear/editar, lo dejo para compatibilidad del JS existente
    window.modalUrls = {
        crear: "<?= url('/admin/productos/crear') ?>",
        editar: "<?= url('/admin/productos/editar') ?>"
    };

    // Para fbselect (categorías y marcas)
...
<div class="productos-modern">
    ...
    <div class="productos-header-modern">
        <div class="productos-header-flex">
            ...
            <!-- Sin botón "Nuevo Producto" para vendedor -->
        </div>
    </div>
    ...
    <!-- =======================
        BUSCADOR + FILTROS (IGUAL AL INVENTARIO ADMIN)
    ======================== -->
    <div class="productos-search-modern">
        ...
        <div class="filters-advanced-bar">
            ...
            <!-- Filtro de estado eliminado (igual que inventario admin) -->
