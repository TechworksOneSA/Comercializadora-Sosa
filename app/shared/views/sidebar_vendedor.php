...
<div class="sidebar-header">
    <div style="width: 110px; height: 110px; background: white; border-radius: 28px; margin: 32px auto 0; position: relative; z-index: 1; display: flex; align-items: center; justify-content: center;">
        <img src="<?= url('/assets/img/logo_sosa.png') ?>" style="width: 150px; height: 150px; object-fit: contain; position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); z-index: 2;" alt="Comercializadora Sosa">
    </div>
...
<nav class="sidebar-nav p-4">
    <ul class="space-y-2">
        ...
        <!-- Gestión de Caja -->
        <li>
            <a href="<?= url('/admin/caja') ?>" class="sidebar-link flex items-center p-3 rounded hover:bg-surface-secondary">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
