        ...
        <li>
            <div class="sidebar-section">
                ...
                <ul class="space-y-1 ml-4">
                    <li>
                        <a href="/pos" class="sidebar-link flex items-center p-2 rounded hover:bg-surface-secondary text-sm">
                    ...
                    <li>
                        <a href="/ventas" class="sidebar-link flex items-center p-2 rounded hover:bg-surface-secondary text-sm">
        ...
        <li>
            <div class="sidebar-section">
                ...
                <ul class="space-y-1 ml-4">
                    ...
                    <li>
                        <a href="/deudores" class="sidebar-link flex items-center p-2 rounded hover:bg-surface-secondary text-sm">
